...
class ui2019(QWidget):
    def __init__(self):
        super(ui2019, self).__init__()
        self.setUpUI()
        self.setWindowTitle("2019年死亡公司数据分析")
    ...
    def setUpUI(self):
        ...
        # Label控件
        self.titlelabel = QLabel("  ---2019年死亡公司数据分析---  ")
        fontTitle = QFont()
        ...
        self.timewebengine.load(QUrl(r"file:///D:/Courses/2020秋-Python/spider/html/liveTimeHistogram_19.html"))
        ...
        # 在QWebEngineView中加载网址
        self.areawebengine.load(QUrl(r"file:///D:/Courses/2020秋-Python/spider/html/chinaMap_2019.html"))

        self.statusLabel = QLabel("融资状态")
        # self.statusgraph = QLabel()
        self.statuswebengine = QWebEngineView(self)
        # self.qwebengine.setGeometry(150, 500, 700, 700)
        # 在QWebEngineView中加载网址
        # self.qwebengine.load(
            # QUrl(r"file:///C:/Users/11477/Documents/tencent%20files/1147770879/filerecv/statuspiechart_20.html"))
        # self.statusgraph.setScaledContents(True)
        self.statuswebengine.load(QUrl(r"file:///D:/Courses/2020秋-Python/spider/html/statusPieChart_19.html"))


        self.typeLabel = QLabel("公司类型")
        self.typewebengine = QWebEngineView(self)
        self.typewebengine.load(QUrl(r"file:///D:/Courses/2020秋-Python/spider/html/companyType_19.html"))
