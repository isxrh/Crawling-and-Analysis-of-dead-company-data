...
class ui2018(QWidget):
    def __init__(self):
        super(ui2018, self).__init__()
        self.setUpUI()
        self.setWindowTitle("2018年死亡公司数据分析")
    ...
    def setUpUI(self):
        ...
        # Label控件
        self.titlelabel = QLabel("  ---2018年死亡公司数据分析---  ")
        fontTitle = QFont()
        ...
        self.timewebengine.load(QUrl(r"file:///D:/Courses/2020秋-Python/spider/html/liveTimeHistogram_18.html"))
        ...
        # 在QWebEngineView中加载网址
        self.areawebengine.load(QUrl(r"file:///D:/Courses/2020秋-Python/spider/html/chinaMap_2018.html"))

        self.statusLabel = QLabel("融资状态")
        # self.statusgraph = QLabel()
        self.statuswebengine = QWebEngineView(self)
        # 在QWebEngineView中加载网址
        self.statuswebengine.load(QUrl(r"file:///D:/Courses/2020秋-Python/spider/html/statusPieChart_18.html"))

        self.typeLabel = QLabel("公司类型")
        self.typewebengine = QWebEngineView(self)
        self.typewebengine.load(QUrl(r"file:///D:/Courses/2020秋-Python/spider/html/companyType_18.html"))
